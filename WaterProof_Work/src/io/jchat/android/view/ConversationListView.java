...
public class ConversationListView {
	...
	public void initModule() {
		// mTitle = (TextView)
		// mConvListFragment.findViewById(R.id.main_title_bar_title);
		// mTitle.setText(mContext.getString(R.string.actionbar_conversation));
		mConvListView = (ListView) mConvListFragment
				.findViewById(R.id.conv_list_view);
		// mCreateGroup = (ImageButton)
		// mConvListFragment.findViewById(R.id.create_group_btn);
		 LayoutInflater inflater = (LayoutInflater)
		 mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		 mHeader = (LinearLayout)
		 inflater.inflate(R.layout.conv_list_head_view, mConvListView, false);
...
//	}
	...
	public void showHeaderView() {
		mHeader.findViewById(R.id.network_disconnected_iv).setVisibility(
				View.VISIBLE);
		mHeader.findViewById(R.id.check_network_hit)
