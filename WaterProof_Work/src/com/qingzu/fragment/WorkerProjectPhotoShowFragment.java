 ...
 * 
 */
public class WorkerProjectPhotoShowFragment extends Fragment implements
		OnClickListener {
	private View v = null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.fragment_worker_detail_project_show,
				container, false);
		initView();
	...
	private void initView() {
		...
		mListView = (ZListView) v.findViewById(R.id.construction_team_list_lv);
		...
		getProjectCaseListByTeamId(WorkerDetailActivity.id, "1", "10",
				REFRESH_DATA_FINISH);
		...
		mListView.setXListViewListener(new IXListViewListener() {
			...
			public void onLoadMore() {
				...
				Count = Count + 1;
				CountStr = Count + "";
				getProjectCaseListByTeamId(WorkerDetailActivity.id, CountStr,
						"10", LOAD_DATA_FINISH);
	...
	public void intiGridView(MyGridView gridView,
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Tools.imageBrower(getActivity(), position, RemarkList);
	...
	private void getProjectCaseListByTeamId(String TeamId, String Page,
		...
		RequestParams params = new RequestParams(
				HttpUtil.ListProjectCaseByMemberId
						.replace("{MemberId}", TeamId).replace("{Page}", Page)
						.replace("{Size}", Size));
