...
public class WorkerFirstFragment extends Fragment implements OnClickListener {
	...
	private View v = null;
	private MyTitleView worker_home_title = null;// 工人首页标题
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.fragment_worker_first, container, false);
		initView();
		getNewMessage();
		return v;
	}
			...
			public void onSuccess(String result) {
				...
				if (interfaceReturn != null) {
					if (interfaceReturn.isStatus()) {
						worker_home_title.setRightImg(getResources().getDrawable(
	...
	public OnCityListener onCityListener = new OnCityListener() {
		...
		public void OnCityAddress(String city) {
			// TODO Auto-generated method stub
			worker_home_title.setLeftText(city);
			nowCity = city;
			list.clear();
	...
	private void initView() {
		...
		worker_home_title = (MyTitleView) v
				.findViewById(R.id.worker_home_title);
		mListView = (ZListView) v.findViewById(R.id.worker_lv_home);
		mListView.setPullLoadEnable(true);
		worker_home_title.setCenterImg(R.drawable.worker_1);
		
		// addHead();
		SharedPreferences preferences1 = getActivity().getSharedPreferences(
				"city", Activity.MODE_PRIVATE);
		nowCity = preferences1.getString("city", "");
		worker_home_title.setLeftText(nowCity);
		worker_home_title.setOnImgCenterClickListener(new OnClickListener() {
...
//		worker_home_title.setOnCenterClickListener(new OnClickListener() {
//
//			@Override
...
//		});
		...
		worker_home_title.setOnLeftClickListener(new OnClickListener() {
		...
		worker_home_title.setOnRightClickListener(new OnClickListener() {
					...
					if (PHONGinterfaceReturn.isStatus()) {
						...
						if (PHONGinterfaceReturn.getResults() != null) {
							...
							if (extensionNumber.getInfoState() != 1) {
								...
								// + extensionNumber.getContactTel().trim()
								);
...
//								MessageURL, InformationTitle);
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == StatusTool.SELECT_CITY) {
			worker_home_title.setLeftText(data.getExtras().getString("city"));
