 ...
 * 
 */
public class WaitAffirmFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.fragment_wait_affirm, container, false);
		initView();
		return v;
	}
	...
	private void initView() {
		...
		mListView = (ZListView) v.findViewById(R.id.fwa_listview);
		mListView.setPullLoadEnable(true);

		WorkerListByStateId("0", "1", "10", BIND_ADAPTER);
		...
		mListView.setXListViewListener(new IXListViewListener() {
			...
			public void onLoadMore() {
				Count = Count + 1;
				CountStr = Count + "";
				WorkerListByStateId("0", CountStr, "10", LOAD_DATA_FINISH);
			}
		});
