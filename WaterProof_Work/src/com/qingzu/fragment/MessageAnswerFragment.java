...
public class MessageAnswerFragment extends Fragment {
		...
		messageAdapter = new MyAdapter<MemberMessage>(getActivity(), list,
			...
			public void convert(ViewHolder view, final int position,
				...
				Item.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						if (!message.isRead()) {
							Read(Tools.formatString(list.get(position).getId()), Infostate);
						...
						case 5:
							i.setClass(getActivity(), RecruitDetailActivity.class);
