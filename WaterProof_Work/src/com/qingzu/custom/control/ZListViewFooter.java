...
public class ZListViewFooter extends LinearLayout {
	...
	public final static String HINT_NOT_DATA = "暂无数据";
	public final static String HINT_NOTDATA = "已经全部加载完毕";
	// 正常状态
	...
	// 没有数据
	public final static int STATE_NULLDATA = 3;
	// 暂无数据
	public final static int STATE_NULL_DATA = 4;
	...
	public void setState(int state) {
		...
		case STATE_NULLDATA:
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(HINT_NOTDATA);
			break;
		case STATE_NULL_DATA:
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(HINT_NOT_DATA);
			break;
