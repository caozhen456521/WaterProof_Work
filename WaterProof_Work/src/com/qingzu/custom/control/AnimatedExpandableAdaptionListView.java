 ...
 */
public class AnimatedExpandableAdaptionListView extends ExpandableListView {
	/*
	...
	public AnimatedExpandableAdaptionListView(Context context) {
		super(context);
	}
	...
	public static abstract class AnimatedExpandableListAdapter extends
		...
		private AnimatedExpandableAdaptionListView parent;

		private static final int STATE_IDLE = 0;
		private static final int STATE_EXPANDING = 1;
		private static final int STATE_COLLAPSING = 2;

		private void setParent(AnimatedExpandableAdaptionListView parent) {
			this.parent = parent;
		}
