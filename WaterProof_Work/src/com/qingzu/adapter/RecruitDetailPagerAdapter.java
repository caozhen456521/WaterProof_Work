...
public class RecruitDetailPagerAdapter extends FragmentPagerAdapter {
	private List<Fragment> list_fragments;

	public RecruitDetailPagerAdapter(FragmentManager fm) {
		super(fm);
		// TODO Auto-generated constructor stub
		list_fragments = new ArrayList<Fragment>();
		list_fragments.add(new RecruitDetailBasciInfoFragment());
		list_fragments.add(new RecruitDetailPhotoShowFragment());
